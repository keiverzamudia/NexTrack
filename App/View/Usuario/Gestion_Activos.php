...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Gestión de Equipos Electrónicos</h1>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#registrarModal">
            <i class="fas fa-plus fa-sm text-white-50"></i> Registrar Nuevo Equipo
        </button>
    </div>
        ...
        <div class="col-lg-10 mx-auto">
            ...
            <div class="card shadow flex-grow-1 ml-auto border-left-primary">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Gestión Total de Equipos</h6>
                </div>
                <div class="card-body">
                    <!-- Barra de búsqueda -->
                    <div class="form-group mb-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="searchInput" placeholder="Buscar por código o nombre del equipo...">
                            ...
                            <tbody>
                                <?php foreach ($activos as $activo): ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($activo['marca']); ?></td>
                                        <td><?php echo htmlspecialchars($activo['modelo']); ?></td>
                                        <td>
                                            <?php
                                            $estadoClass = '';
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modificarModalLabel<?php echo $activo['id']; ?>">Modificar Equipo</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="tipo" name="tipo" required>
                                                                <option value="PC" <?php echo $activo['tipo'] === 'PC' ? 'selected' : ''; ?>>Computadora</option>
                                                                <option value="Monitor" <?php echo $activo['tipo'] === 'Monitor' ? 'selected' : ''; ?>>Monitor</option>
                                                                <option value="Impresora" <?php echo $activo['tipo'] === 'Impresora' ? 'selected' : ''; ?>>Impresora</option>
                                                                <option value="Router" <?php echo $activo['tipo'] === 'Router' ? 'selected' : ''; ?>>Router</option>
                                                                <option value="Switch" <?php echo $activo['tipo'] === 'Switch' ? 'selected' : ''; ?>>Switch</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="departamento">Departamento</label>
                                                            <select class="form-control" id="departamento" name="departamento" required>
                                                                <option value="ITV" <?php echo $activo['departamento'] === 'ITV' ? 'selected' : ''; ?>>ITV</option>
                                                                <option value="PAL" <?php echo $activo['departamento'] === 'PAL' ? 'selected' : ''; ?>>PAL</option>
                                                                <option value="MER" <?php echo $activo['departamento'] === 'MER' ? 'selected' : ''; ?>>MER</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="marca">Marca</label>
                                                            <input type="text" class="form-control" id="marca" name="marca" value="<?php echo htmlspecialchars($activo['marca']); ?>" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="modelo">Modelo</label>
                                                            <input type="text" class="form-control" id="modelo" name="modelo" value="<?php echo htmlspecialchars($activo['modelo']); ?>" required>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="estado" name="estado" required>
                                                                ...
                                                                <option value="mantenimiento" <?php echo $activo['estado'] === 'mantenimiento' ? 'selected' : ''; ?>>En Mantenimiento</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="modal fade" id="asignarModal<?php echo $activo['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="asignarModalLabel<?php echo $activo['id']; ?>" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="asignarModalLabel<?php echo $activo['id']; ?>">Asignar Equipo</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                    ...
                                    <div class="modal fade" id="eliminarModal<?php echo $activo['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="eliminarModalLabel<?php echo $activo['id']; ?>" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ¿Está seguro que desea eliminar el equipo "<?php echo htmlspecialchars($activo['nombre']); ?>"?
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
...
<div class="modal fade" id="registrarModal" tabindex="-1" role="dialog" aria-labelledby="registrarModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="registrarModalLabel">Registrar Nuevo Equipo</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
